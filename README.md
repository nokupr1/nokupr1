...
<!--
**nokupr1/nokupr1** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
I am a passionate **Python Developer**, **IT Tutor**, and **Applied Informatics Student** dedicated to building clean, efficient, and automated solutions. I thrive in a keyboard-driven environment, crafting code with the same precision I use to rice my desktop.
